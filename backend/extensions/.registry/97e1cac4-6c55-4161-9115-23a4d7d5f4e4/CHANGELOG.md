...
[compare changes](https://github.com/codihaus/directus-extension-kanboard/compare/v0.0.14...v0.0.15)

### 🩹 Fixes

- 🐛  fix missing punctuation error ',' ([271f3e1](https://github.com/codihaus/directus-extension-kanboard/commit/271f3e1))

### 🏡 Chore

- Update pnpm-lock ([d46a436](https://github.com/codihaus/directus-extension-kanboard/commit/d46a436))
- Build ([f99ab0f](https://github.com/codihaus/directus-extension-kanboard/commit/f99ab0f))

### 🎨 Styles

- 🎨  fixx ui hover change log detail ([60219f6](https://github.com/codihaus/directus-extension-kanboard/commit/60219f6))
- **card:** 🔥  styling for dark mode ([ae25b6a](https://github.com/codihaus/directus-extension-kanboard/commit/ae25b6a))
